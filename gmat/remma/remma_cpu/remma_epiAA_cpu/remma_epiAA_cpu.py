...
def remma_epiAA_cpu(y, xmat, zmat, gmat_lst, var_com, bed_file, snp_lst_0=None, p_cut=1.0e-4, out_file='remma_epiAA_cpu'):
    """
    ...
    :param out_file: output file. default value is 'remma_epiAA_cpu'.
    :return: 0
    """
...
def remma_epiAA_cpu_parallel(y, xmat, zmat, gmat_lst, var_com, bed_file, parallel, p_cut=1.0e-4, out_file='remma_epiAA_cpu'):
    """
    ...
    :param p_cut: put cut value. default value is 0.0001.
    :param out_file: The prefix for output file. default value is 'remma_epiAA_cpu'.
    :return: 0
    """
    ...
    res = remma_epiAA_cpu(y, xmat, zmat, gmat_lst, var_com, bed_file, snp_lst_0=snp_list_0, p_cut=p_cut,
